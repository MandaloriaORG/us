  ...
  return (
    <header className="border-border flex flex-col gap-3 border-b pb-4 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <Link
          href="/codex"
          className="text-fg hover:text-brand focus-visible:ring-border-focus inline-flex items-center gap-2.5 focus-visible:ring-2 focus-visible:outline-hidden"
        >
          ...
          <span className="font-display from-brand to-brand-light bg-linear-to-r bg-clip-text text-2xl font-semibold tracking-tight text-transparent">
            Codex Libre
          </span>
        </Link>
