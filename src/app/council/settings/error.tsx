...
export default function SettingsError({
  ...
  useEffect(() => {
    console.error("Site settings failed to load.", { digest: error.digest });
  }, [error.digest]);
  ...
  return (
    <div className="mx-auto w-full max-w-4xl">
      <div role="alert" className="flex max-w-lg items-start gap-3">
        ...
        <div>
          <h1 className="text-fg text-xl font-semibold">Settings unavailable</h1>
          <p className="text-fg-muted mt-2 text-sm">
            We could not load the site settings. Try again in a moment.
          </p>
