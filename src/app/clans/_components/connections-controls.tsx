          ...
          {requests.map((request) => (
            ...
            >
              <Link
                ...
                className="text-fg min-w-0 flex-1 truncate text-sm hover:underline"
              >
                {request.peerName}
              </Link>
              <span className="border-border text-fg-muted inline-flex shrink-0 items-center rounded-full border px-2.5 py-0.5 text-xs">
                {request.direction === "incoming" ? "Pending" : "Awaiting reply"}
              </span>
